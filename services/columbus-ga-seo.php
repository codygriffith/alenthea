...
<body>
	...
	<section class="full flex center column" id="columbusGaWebDesign">
		...
		<h2>Your local choice for professional SEO services.</h2>
		<p class="font-two">If you are searching for the top choice for SEO, then you have found it with Alenthea. 
		We employ the latest and greatest techniques that are guaranteed to not only rank your website fast, but 
		to also make sure it stays there.
		</p>
	</div>
	</section>
	...
	<section class="flex center" id="designSolutions">
		<section>
			<h1>Alenthea Does SEO Right!</h1>
			<p>Get in front of your audience and generate natural organic traffic by improving your website's content as well as your code's internal structure.</p>
		</section>
	<div class="flex space-between">
		<section>
			<h1>Technical SEO</h1>
			<p>Technical SEO is the foundational principal of any truly effective Search Engine Optimization strategy. 
			   It covers your website's PageSpeed, internal structure, behavior, security, and any other technical 
			   requirements that today's search engines look for.
			</p>
			<p>This is our #1 approach to differentiating our clients' websites from the competition for higher 
			   rankings and long term domain authority.
			</p>
		</section>
		<section>
			<h1>Creative Website Design</h1>
			<p>Local SEO allows your website to capture search traffic for the specific area's your business 
			   operates in. We start by taking ownership and optimizing your business' profile on Google My Business,
			   Yelp, and many others. 
			</p>
			<p>Then we collect and add relevant location-specific copy to your webpage content, including phone numbers, 
			   addresses, schema markup, and local content about the specific service area's you wish to target.
			</p>
		</section>
	</div>
	</section>
