...
<body>
	...
	<div id="hero" class="flex column">
	<h1 class="flex column bigOlText left">
            <span>Your choice for </span>
            Atlanta Web Design.
	</h1>
	<p>We aim to be the number one Atlanta Web Design & Development agency. We come prepared to serve your business by mastering your company's 
	  website design and underlying technical structure. Get a website built to work for you. </p>
